...
"font-size: 12pt")
        ...
        self.pushButton.setGeometry(QtCore.QRect(20, 500, 401, 31))
...
"text-align:left")
        ...
        self.pushButton_2.clicked.connect(lambda: self.doWork(client))
    ...
    def doWork(self,client):
        inParamsTuple = (self.pushButton.text(),True)
        # inParamsTuple = ("D:/Projects/pneumonia-detection/fixtures/pneumonia_1.jpeg", True)
        if self._wndMain.theAppConfig.use_debug_values:
            inParamsTuple = (self._wndMain.theAppConfig.xray_path, True)
    ...
    def savePatient(self,res_tuple_pneumania,client):
        ...
        client.send_patient(full_name, ID, email, "M",date, case_description, date, str(chance), self._iDoctor_id)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_10.setText(_translate("Dialog", "X-ray file (Optional):"))
        self.label_12.setText(_translate("Dialog", "X-ray detection results:"))
